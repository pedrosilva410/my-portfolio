  ...
  return (
    <header className="header">
      <ul className="nav">
        ...
        <li>
          <NavLink exact className="nav_item" activeClassName="nav_item_selected" to="/projects">
            Projects
          </NavLink>
        </li>
      </ul>
      ...
      <div className="header__contact_container">
          <NavLink className="header__contact" activeClassName="nav_item_selected" to="/contact">
            Contact
          </NavLink>
          </div>
    </header>
